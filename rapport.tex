...
\begin{itemize}
    ...
    \item Developpement Team : Alban Rouiller
...
L'accès au backlog peut se faire via ce lien : \href{https://github.com/users/Ramdek/projects/1}{Backlog GitHub}
...
Les Milestones du projet sont disponible via ce lien : \href{https://github.com/Ramdek/cleanistere/milestones?sort=title&direction=asc}{Milestones GitHub}
...
Vous pouvez retrouver la maquette du site ici : \href{https://excalidraw.com/#room=7317f75d85cd1c33599f,4EBI3ZhyrUezl7wpOETm1Q}{Maquette Excalidraw} et en annexe \ref{maquette}
...
Les personas et User story peuvent-être trouvées sur \href{https://github.com/Ramdek/cleanistere/blob/main/README.md}{Persona et user story GitHub}
\begin{figure}[H]
    \centering
    \vspace{-2cm}
